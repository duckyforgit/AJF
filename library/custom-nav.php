...
if ( ! function_exists( 'wpt_register_theme_customizer' ) ) :
	function wpt_register_theme_customizer( $wp_customize ) {
		...
		$wp_customize->add_panel(
			'footer_menu_settings', array(
				'priority'       => 1000,
				'theme_supports' => '',
				'title'          => __( 'Footer Menu Settings', 'foundationpress' ),
				'description'    => __( 'Controls the footer menu', 'foundationpress' ),
			)
		);
		...
		// Create custom field for mobile navigation layout
		$wp_customize->add_section(
			'footer_menu_layout', array(
				'title'    => __( 'Footer navigation layout', 'foundationpress' ),
				'panel'    => 'footer_menu_settings',
				'priority' => 1000,
			)
		);
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				array(
					'type'     => 'radio',
					'section'  => 'footer_menu_layout',
					'settings' => 'wpt_footer_menu_layout',
					'choices'  => array(
						'topbar'    => 'Footerbar',						
					),
				)
	...
	add_filter( 'body_class', 'footer_nav_class' );
	function footer_nav_class( $classes ) {
		if ( ! get_theme_mod( 'wpt_footer_menu_layout' ) || get_theme_mod( 'wpt_footer_menu_layout' ) === 'footerbar' ) :
			$classes[] = 'footerbar';		 
		endif;
		return $classes;
	}
